...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        mEmailSignInButton.setOnClickListener(new OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                ...
                int res = user.validaLogin(dh, String.valueOf(email.getText()), String.valueOf(senha.getText()));

                if ( res != -1)
                {
                    Intent intent = new Intent(LoginActivity.this, CarrosActivity.class);
                    intent.putExtra("id", res);
                    startActivity(intent);
                }
                else
                {
                    email.setError("Email ou senha estão incorretos!");
    ...
    public void clicar_registrar(View v)
    {
