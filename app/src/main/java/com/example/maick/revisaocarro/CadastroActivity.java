    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        mEmailSignInButton.setOnClickListener(new OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                ...
                if (!u.validaRegistro(dh, String.valueOf(email.getText())))
                {
                    //dh.db.execSQL("DELETE FROM usuarios");
                    String t = "'"+ dh.Autoincremento("usuarios", "id_usuario") +"', '"+ nome.getText() +"', '"+ email.getText() +"', " + "'"+ senha.getText() +"'";
                    dh.insert("usuarios", t);
                ...
                else
                {
                    ...
                    tx.setText("Email já existe, insira um email diferente!");
                }
            }
        });
